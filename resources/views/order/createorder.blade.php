            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="container pt-4">
                        <div class="alert alert-warning alert-dismissible fade show d-flex align-items-center " role="alert" style="padding:10px;">
                            ...
                            <div style="font-size: 13px;">
                                &nbsp;Harap sebelum order melakukan <a href="{{ route('regispel.createmember') }}" class="alert-link">Registrasi Pelanggan</a>
                            </div>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="padding: 8px;">
