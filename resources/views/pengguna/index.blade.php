...
@section('content')
    <section id="crudsiswa">
        ...
        <div class="card">
            <div class="container">
                <a href="{{route('pengguna.createpengguna')}}"><button class="btn mt-4 text-white" style="background-color:#43D39E;"><i class="fas fa-user-plus mr-1"></i> Tambah Data</button></a>
