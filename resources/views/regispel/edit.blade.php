        ...
        <div class="card-head">
            <div class="container text-white">
                <div style="font-size: 15px; padding-top: 14px;" >
                    <i class="fas fa-edit pr-2" style="font-size: 15px;"></i> <span>Edit Paket</span>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="container pt-4">
                <form action="{{route('regispel.update',[$member->id])}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="" value="{{ $member->nama }}" name="nama" >
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('tlp') is-invalid @enderror" id="" value="{{ $member->tlp }}" name="tlp" >
                                @error('tlp')
                                <small class="text-danger ">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" id="deks" cols="30" rows="10" class="form-control @error('alamat') is-invalid @enderror"  maxlength="250">{{ $member->alamat }}</textarea>
